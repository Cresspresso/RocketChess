...
**	File		:	Model.h
**
**	Summary		:	Model made up of mesh objects.
**
...
public:
	...
	Model(std::string path, GLuint program/*, Camera* camera*/){

		// EDIT
		this->program = program;// ShaderLoader::GetInstance()->CreateProgram("Model.vs", "Model.fs");
		// EDIT END
...
private:
	...
	void loadModel(std::string path)
	{
		...
		{
			console::error(stringLink("ERROR::ASSIMP:: ", importer.GetErrorString()));
			return;
		}
	...
	GLint TextureFromFile(const char* path, std::string directory)
	{
		...
		console::log(stringLink("texture filename: ", filename));
